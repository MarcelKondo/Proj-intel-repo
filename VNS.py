...
def run_VNS_greedy(S0, IterMax, nb_tour, NbP, Me, exploring_param):          #exploring_param = ['n1', 'n2', 'n3', 'tblock1', 'tblock2', 'tblock3']
    tot_iter = 0
    tour = 0
    S = S0
    while tour < nb_tour:
        for param in exploring_param:
            ...
            tot_iter += iter
        tour+=1
    print(20*"__", "end of turn {}/{} : {},{}".format(tour,nb_tour,e,S))
    return e,S,tot_iter      

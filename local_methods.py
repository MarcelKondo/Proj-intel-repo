...
if __name__ == "__main__":
    ...
    if(args.method == "HC"):
        ...
        if Me == 0:
            ...
            print("\n")
            print(E_0)
            print(pd.DataFrame({'Ratio e_b/e_0': [eb_HC/E_0,best_E_PHC/E_0,best_E_GR/E_0,best_E_TGR/E_0,eb_SA/E_0], 'Run time':[dt_HC,dt_PHC,dt_GR,dt_TGR,dt_SA]},index=['HC','PHC','GR','TGR','SA']))

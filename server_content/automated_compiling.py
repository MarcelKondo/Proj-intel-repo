...
def define_exec_param(n1 = 256, n2 = 256, n3 = 256, nb_threads = 4, nb_it = 100, tblock1 = 32 , tblock2 = 32, tblock3 = 32):
    res = subprocess.run("cd ~/Proj-Intel/Appli-iso3dfd/bin && iso3dfd_dev05_cpu_avx512.exe " + str(n1) + " " + str(n2) + " " + str(n3) + 
